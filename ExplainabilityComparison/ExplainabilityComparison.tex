...
\begin{itemize}[noitemsep]
    \item \textbf{level 1 } - top-5 snapshots models were selected to generate the full model, ii) \item \textbf{level 2} - only the best model is selected for the final ensemble. 
\end{itemize}

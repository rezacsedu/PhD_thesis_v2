...
\begin{itemize}
    \item The ER status classification is the task for determining the existence of ER protein inside breast cancer patient. Each patient can be classified into one of ER- `POSITIVE', `NEGATIVE', or `INDETERMINATE'\footnote{Patients can't be grouped as positive, negative, or equivocal}. 
    \item The PGR status classification is the task for determining the existence of PGR protein inside breast cancer patient. Similar to ER status, each patient can be classified into one of PGR- `POSITIVE', `NEGATIVE', or `INDETERMINATE'. 
    \item The HER2/neu status classification is the task for determining the existence of HER2 in the breast cancer patient. Unlike ER and PGR status, HER2/neu status is the most important predictive and prognostic biomarker for breast cancer. Each patient can be classified into one of four types: `POSITIVE', `NEGATIVE', `INDETERMINATE', and `EQUIVOCAL'\footnote{Assessments without information on how to treat a patient}. 
\end{itemize}

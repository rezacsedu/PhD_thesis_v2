...
Till date, only a few ontologies have been developed 
However, these ontologies are mostly generalized data models that have not yet been used in conjunction with big data to form a KG. 

...
\subsection{Network construction and training}\label{nc}
...
\begin{figure*}[h]
    ...
    \caption[Schematic representation of the CAE classifier]{Schematic representation of the CAE classifier~\cite{karimACCA2019}}
	\label{fig:cae}
\end{figure*}
...
\begin{figure}
    ...
    \caption[Model averaging ensemble of CLSTM and CAE snapshots]{Model averaging ensemble of CLSTM and CAE snapshots~\cite{karimACCA2019}}
    \label{fig:mae}
    \vspace{-2mm}
\end{figure}

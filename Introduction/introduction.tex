...
Before, we formally define the problem, we introduce some notations necessary to grasps the cancer typing method necessary in our DSS. We start by introducing cancer types and subtypes in the context of a DSS for cancer diagnosis: 

...
\hspace*{3.5mm} The above equations is equivalent to decomposing into individual modality specific representations of individual modalities, $\hat{X}_{c}$, $\hat{X}_{e}$, and $\hat{X}_{r}$:  

...
\hspace*{3.5mm} However, the use of attention mechanisms for high-dimensional tabular data is quite restrictive, except for a recent approach called self-attention networks~(SANs) proposed by Matej et al.~\cite{vskrlj2020feature}. Besides, it is yet not clear how the attention concept can be used for computing feature importance in multimodal input setting.

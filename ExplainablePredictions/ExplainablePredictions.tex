...
\hspace*{3.5mm} To improve the algorithmic transparency, different probing techniques are employed to open the `black-box' models. %towards making them explainable. 
...
%\hspace*{3.5mm} Most common cancers diagnosed in men are prostate, lung, and colorectal cancers, while breast, lung, and colorectal cancers are among women~\cite{li2017comprehensive}.

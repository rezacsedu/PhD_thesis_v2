...
\begin{sidewaysfigure}
	...
	\captionsetup{justification=centering}
		\includegraphics[width=0.6\textwidth]{images/decision_rules_explain.png}
...
\begin{figure}
	\centering
		\includegraphics[width=0.5\textwidth]{images/dr_global_1.png}
